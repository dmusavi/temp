...
download_verify_image() {
  ...
  log "Extracting Arch Linux bootstrap tarball into bundle/rootfs..."
  tar --use-compress-program=unzstd -xpf "downloads/$IMAGE_FILE" -C "bundle/rootfs" --strip-components=1 || error_exit "Extraction failed."
